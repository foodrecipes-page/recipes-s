...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 's'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-s@main/recipes/<cuisine>/<diet>/<slug>.json
```
